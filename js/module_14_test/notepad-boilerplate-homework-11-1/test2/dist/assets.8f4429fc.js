...
},{"./lib/axios":"node_modules/axios/lib/axios.js"}],"assets/index.js":[function(require,module,exports) {
"use strict";
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return _axios.default.get("todos/".concat(id));
...
function () {
  ...
  return function updateTodoUI() {
    return _ref2.apply(this, arguments);
  };
}();

updateTodoUI(); // getTodo(1)
// .then(console.log)
// .catch(console.log);
////////////
