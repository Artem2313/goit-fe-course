...
// и
//  верни true или false в зависимости от того, попадает 
//  ли длина параметра в заданный диапазон от 4-х до 16-ти символов включительно.
...
// Если логин валиден, функция addLogin проверяеть 
// уникальность логина с помощью функции isLoginUnique
// Если isLoginUnique вернет false, тогда addLogin
